...
DTMF_TRACKS = [
    ...
    {"track_number": 5, "name": "WELTiTA", "charge_color": "green", "assessment": "Innocent beach romance — harmless, light entertainment"},
    {"track_number": 6, "name": "VeLDÁ", "charge_color": "red", "assessment": "Sexual conquest, ego, possessiveness, materialism"},
    {"track_number": 7, "name": "EL CLúB", "charge_color": "green", "assessment": "Light paternalistic romance"},
    ...
    {"track_number": 11, "name": "TURiSTA", "charge_color": "blue", "assessment": "Genuine vulnerability — processor"},
    {"track_number": 12, "name": "CAFé CON RON", "charge_color": "red", "assessment": "Club, drugs, ex-obsession, commiseration"},
    {"track_number": 13, "name": "PIToRRO DE COCO", "charge_color": "blue", "assessment": "Processor — holiday heartbreak, culturally grounded"},
    {"track_number": 14, "name": "LO QUE LE PASÓ A HAWAii", "charge_color": "violet", "assessment": "Political, communal, sovereign — the real thing"},
...
ALBUMS = [
    {
        ...
        "release_year": 2025,
        "overall_color": "red",
        "summary": "The 2026 Album of the Year: Bait and Switch on a Global Scale. 59% red-charged tracks. One violet gem buried at track 14.",
        "tracks": DTMF_TRACKS,
    }
]
