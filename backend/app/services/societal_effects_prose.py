...
- Describe what is present. A thing named by what it lacks is a hole where the description should be. This is not a list of banned phrases and cannot be, because every negation has an honest use somewhere, this lane included: a population growing LESS WILLING to accept something is the correct clinical form for a decline. The test is whether the negation is CARRYING the description: take it out, and if the sentence still reports what manifests in the population it stays. If it collapses, the finding has not been found yet. Name what a society does, tolerates, demands, or grows practised at.
